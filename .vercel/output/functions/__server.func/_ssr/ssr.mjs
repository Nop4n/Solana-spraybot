...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-41YXMsK3.mjs");
...
var manifest = { "0aa61bdbaa7f5bec5dc0dc41c08cff5959898c51dd30793b3e3c206a2876d06a": {
	functionName: "fetchLiveRadar_createServerFn_handler",
	importer: () => import("./radar-1Rt9qGf3.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BgoYawOT.mjs").then((n) => n.t),
